...
namespace Web_xemphim.Areas.Admin
{
    ...
    public class GenresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GenresId,Name,Checked")] Genre genre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GenresId,Name,Checked")] Genre genre)
        {
            if (id != genre.GenresId)
            {
                return NotFound();
            }
        ...
        {
          return (_context.Genres?.Any(e => e.GenresId == id)).GetValueOrDefault();
        }
    }
}
